...
Il est donc **essentiel de surveiller ** tout périphérique USB connecté à une machine, notamment sur les postes critiques, afin de prévenir tout comportement non autorisés.
